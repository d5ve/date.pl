...
sub test_parsing {
    ...
    my $local_28_minutes_ago  = DateTime->now( time_zone => 'Pacific/Auckland' )->subtract( minutes => 28 );
    my $remote_28_minutes_ago = $local_28_minutes_ago->clone->set_time_zone('Europe/London');
    
    my @tests = (
        { in => q{28 minutes ago},                        local => qq{$local_28_minutes_ago}, remote => qq{$remote_28_minutes_ago} },
        { in => q{26 March 2015 at 06:05},                local => q{2015-03-26T06:05:00},    remote => q{2015-03-25T17:05:00} },
        ...
        { in => q{Wed, 25 Mar 2015 14:25:03 (PDT)},       local => q{2015-03-26T10:25:03},    remote => q{2015-03-25T21:25:03} },
        { in => q{Mar 26 9:53 AM},                        local => q{2015-03-26T09:53:00},    remote => q{2015-03-25T20:53:00} },
        { in => q{March 26, 2015 at 10:51:30 AM UTC+13},  local => q{2015-03-26T10:51:30},    remote => q{2015-03-25T21:51:30} },
    );

    foreach ( @tests ) {
        my $date = Date->new(date_str => $_->{in});
